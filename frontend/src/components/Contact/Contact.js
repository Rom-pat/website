    ...
    render() {
        ...
        <div id="Contact">
            <Header />
             ...
             <a href='mailto:romit3775@gmail.com'><img className="h-1/2" src={Gmail} alt="Gmail"></img></a>
             <a href='https://www.linkedin.com/in/romit-patel-/' target='_blank' rel='noreferrer'><img className="h-1/2" src={Linkedin} alt="Linkedin"/> </a>
              ...
              <textarea className="paragraph_input" placeholder='Description...'></textarea><br /><br />
