    ...
    render() {
        return(
            ...
            <ul className='horizontal_list'>
                <li> <a className="App-link" href="/projects" target="_self"> Projects</a></li>
                ...
                <li> <a className="App-link" href="/about" target="_self" > About </a></li>
                <li> <a className="App-link" href="/contact" target="_self" > Contact </a></li>
            </ul>
            </div>
            </div>
        )
